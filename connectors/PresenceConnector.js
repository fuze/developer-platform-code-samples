  ...
  constructor(config) {
    ...
    getAllWebhooksPromise(nextCursor) {
        ...
        return this.httpClient
            .withPath('/api/v1/webhooks/presence')
    ...
    getWebhookByIdPromise(webhookId) {
        return this.httpClient
            .withPath('/api/v1/webhooks/presence/' + webhookId)
            .withHeaders({'Authorization': 'Bearer ' + this.authToken, 'X-Long-Encoding' : 'string'})
            .withMethodGet()
            .send()
            .then(response => response.body);
    ...
    getWebhookSubscriptionsPromise(webhookId, nextCursor) {
        ...
        return this.httpClient
            .withPath('/api/v1/webhooks/presence/' + webhookId + '/subscriptions')
            .withHeaders({'Authorization': 'Bearer ' + this.authToken, 'X-Long-Encoding' : 'string'})
            .withParams(query)
            .withMethodGet()
            .send()
    ...
    getWebhookSubscriptionByIdPromise(webhookId, subscriptionId) {
        return this.httpClient
            .withPath('/api/v1/webhooks/presence/' + webhookId + '/subscriptions/' + subscriptionId)
            .withHeaders({'Authorization': 'Bearer ' + this.authToken, 'X-Long-Encoding' : 'string'})
            .withMethodGet()
            .send()
            .then(response => response.body);
    ...
    createWebhookSubscriptionsPromise(webhookId, listOfUserIds, optionalExpirationDate) {
